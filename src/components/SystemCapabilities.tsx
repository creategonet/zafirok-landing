    ...
    <section className="relative overflow-hidden py-20 sm:py-32">
      ...
      <div className="relative mx-auto max-w-7xl px-5 sm:px-6">
        ...
        >
          ...
          <h2 className="font-display mt-4 text-[2rem] leading-tight font-bold tracking-tight text-balance text-white min-[380px]:text-4xl md:text-6xl">
        ...
        <motion.div
          ...
          transition={{ duration: 0.7, ease: [0.22, 1, 0.36, 1] }}
          className="mt-12 overflow-hidden rounded-3xl border border-sapphire-400/20 bg-gradient-to-br from-sapphire-500/10 via-surface/70 to-surface/40 p-5 backdrop-blur-sm sm:mt-16 sm:rounded-[2rem] sm:p-8 md:p-10"
        >
          <div className="flex flex-col justify-between gap-4 md:flex-row md:items-center">
            <div>
              <span className="text-xs font-semibold tracking-[0.22em] text-sapphire-300 uppercase">Module operaționale</span>
              <h3 className="font-display mt-2 text-xl font-bold text-balance text-white sm:text-2xl md:text-3xl">Construiește sistemul potrivit afacerii tale</h3>
            </div>
          ...
          <div className="mt-6 grid grid-cols-2 gap-2.5 sm:mt-8 sm:grid-cols-4 sm:gap-3 lg:grid-cols-8">
        ...
        <div className="mt-4 grid gap-4 sm:mt-6 sm:gap-6 md:grid-cols-2 lg:grid-cols-3">
          {platformGroups.map((group, index) => (
            <motion.article
              ...
              className="relative overflow-hidden rounded-3xl border border-line bg-surface/55 p-6 backdrop-blur-sm sm:rounded-[2rem] sm:p-8 lg:min-h-[500px] transition-all duration-300 hover:-translate-y-1 hover:border-sapphire-400/30"
            >
              ...
              <h3 className="font-display mt-5 text-xl font-bold text-white sm:mt-6 sm:text-2xl">{group.title}</h3>
              <div className="mt-6 h-px bg-gradient-to-r from-sapphire-400/40 to-transparent sm:mt-7" />
        ...
        <div className="mt-4 grid gap-3 sm:mt-6 sm:grid-cols-3">
          <div className="flex items-center gap-3 rounded-2xl border border-line bg-ink/50 px-5 py-4 text-sm text-slate-300"><IconCloud className="h-5 w-5 shrink-0 text-sapphire-300" /> Cloud pe orice dispozitiv</div>
          <div className="flex items-center gap-3 rounded-2xl border border-line bg-ink/50 px-5 py-4 text-sm text-slate-300"><IconRefresh className="h-5 w-5 shrink-0 text-sapphire-300" /> Sincronizare în timp real</div>
          <div className="flex items-center gap-3 rounded-2xl border border-line bg-ink/50 px-5 py-4 text-sm text-slate-300"><IconChart className="h-5 w-5 shrink-0 text-sapphire-300" /> Date pregătite pentru decizii</div>
        </div>
      </div>
    </section>
  );
